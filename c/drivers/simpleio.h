...
#define SIMPLEIO_INPUT                                                         \
    ((volatile const unsigned char*)(SIMPLEIO_BASE + SIMPLEIO_INPUT_OFFSET))
#define SIMPLEIO_OUTPUT                                                        \
    ((volatile unsigned char*)(SIMPLEIO_BASE + SIMPLEIO_OUTPUT_OFFSET))
#define SIMPLEIO_FLAGS                                                         \
    ((volatile unsigned char*)(SIMPLEIO_BASE + SIMPLEIO_FLAGS_OFFSET))
